...
namespace ChimeWebApi.Migrations.ProductDatabaseMigrations
{
    ...
    [Migration("20251012053409_ProductDb1")]
    partial class ProductDb1
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("ChimeWebApi.Entities.Product", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("1cb3b63c-c1b8-44a6-8452-dce9475ebd24"),
                            CategoryId = 2,
                        ...
                        new
                        {
                            Id = new Guid("c0de78e0-8f72-467e-8ec7-d0f9316d5877"),
                            CategoryId = 2,
                        ...
                        new
                        {
                            Id = new Guid("de1a7f92-5429-4af3-a5b4-2b7bcd648aea"),
                            CategoryId = 3,
                        ...
                        new
                        {
                            Id = new Guid("d171b44b-b279-4417-a95d-a1af73a93448"),
                            CategoryId = 3,
                        ...
                        new
                        {
                            Id = new Guid("c3f1b6d8-143b-4683-87e0-f519aecde25b"),
                            CategoryId = 4,
            ...
            modelBuilder.Entity("ChimeWebApi.Entities.Product", b =>
                {
                    ...
                    b.HasOne("ChimeWebApi.Entities.Transaction", "Transaction")
                        .WithMany()
